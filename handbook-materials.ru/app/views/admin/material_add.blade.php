            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="{{ action('AdminController@postMaterial') }}" enctype="multipart/form-data">
				...
				<div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">Свойства (через запятую, если свойств несколько)</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="properties" value=""></div>
                                </div>
				<div class="hr-line-dashed"></div>
