...
'Base URL problem'                  =>  'Сервер не поддерживает нелатинские символы в домене. Т.к. ваш URL содержит такие символы, вы <strong>должны</strong> воспользоваться сторонним конвертером во избежание ошибки "Плохой HTTP_REFERER".',
